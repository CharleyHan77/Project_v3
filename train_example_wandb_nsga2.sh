...
# 设置数据路径（请根据实际情况修改）
FJS_ROOT_PATH="/workspace/Project_v3/dataset_nsga2_0324"
LABEL_ROOT_PATH="/workspace/Project_v3/init_validity_result_nsga2_0324"
# FJS_ROOT_PATH="/workspace/Project_v3/dataset_nsga2"
# LABEL_ROOT_PATH="/workspace/Project_v3/init_validity_result_nsga2"
